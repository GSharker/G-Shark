...
namespace GShark.Test.XUnit.Geometry
{
    public class PlaneTests
    {
        ...
        public static Plane BasePlane => new Plane(new Point3d(5, 0, 0 ), new Point3d(10, 15, 0));
        public static Plane BasePlaneByPoints => new Plane(new Point3d( 20, 20, 0 ), new Point3d( 5, 5, 0), new Point3d( -5, 10, 0));

        [Fact]
        public void It_Initializes_A_Plane()
        {
            // Arrange
            var origin = new Point3d(5, 5, 0);
        ...
        {
            // Arrange
            var pt1 = new Point3d(5, 0, 0);
            var pt2 = new Point3d(10, 0, 0);
            var pt3 = new Point3d(15, 0, 0);
        ...
        {
            // Arrange
            var pt1 = new Point3d(20, 20, 0);
            var pt2 = new Point3d(5, 5, 0);
        ...
        public void It_Returns_A_Plane_With_A_New_Origin()
        {
            // Arrange
            Plane plane = BasePlaneByPoints;
            var newOrigin = new Point3d( 50, 60, 5);
        ...
        public void It_Returns_A_Plane_Which_Fits_Through_A_Set_Of_Points()
        {
            ...
            var originCheck = new Point3d(86.266409, 29.701102, -0.227864);
            var normalCheck = new Point3d( 0.008012, 0.253783, 0.967228);
