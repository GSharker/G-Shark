...
namespace GShark.Test.XUnit.Data
{
    ...
    {
        public static Point3d[] BoundingBox2D()
        {
            return new[]
            {
                new Point3d(0d, 0d, 0),
                new Point3d(10d, 0d, 0),
                new Point3d(10d, 10d, 0),
                new Point3d(5d, 5d, 0)
            };
        }
        public static Point3d[] BoundingBox3D()
        {
            return new[]
            {
        ...
        public static Point3d[] NegativeBoundingBox()
        {
            return new[]
            {
                new Point3d(-15d, -15d, 0),
                new Point3d(-5d, -5d, 0)
            };
        }

        public static Point3d[] NegativeMinValuePositiveMaxValue()
        {
            return new[]
            {
                new Point3d(-12d, -17d, 0),
                new Point3d(10d, 13d, 0)
            };
        }

        public static Point3d[] BoundingBoxWithZValue()
        {
            return new[]
            {
                new Point3d(-12d, -17d, -10),
                new Point3d(10d, 13d, 5)
            };
        }
        ...
        public static IEnumerable<object[]> BoundingBoxCollections
        {
            get
            {
                ...
                yield return new object[] {BoundingBox3D(), new Point3d(74.264416, 13.940616, -4.22451), new Point3d(100.92443, 45.16886, 3.812853)};
        ...
        public static TheoryData<Point3d[], BoundingBox> BoundingBoxIntersectionsUnset => 
            new TheoryData<Point3d[], BoundingBox>
            {
