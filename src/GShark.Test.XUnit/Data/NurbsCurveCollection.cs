...
namespace GShark.Test.XUnit.Data
{
    public class NurbsCurveCollection
    {
        ...
        public static List<NurbsCurve> SetOfClosedNurbsCurves()
        {
            ...
            NurbsCurve c1 = new NurbsCurve(pts1, degree).Close();
            NurbsCurve c2 = new NurbsCurve(pts2, degree).Close();
            NurbsCurve c3 = new NurbsCurve(pts3, degree).Close();
            NurbsCurve c4 = new NurbsCurve(pts4, degree).Close();
