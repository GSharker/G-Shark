...
{
    //ToDo Add Operator overload for Vector3 * 4x4 Matrix (represent vector as x,y,z,0 column see https://www.euclideanspace.com/maths/geometry/affine/matrix4x4/index.htm)
    /// <summary>
    ...
    public struct Vector3 : IEquatable<Vector3>, IComparable<Vector3>, IComparable
    {
        ...
        /// <summary>
        /// Converts a vector3 in a vector3, without needing casting.
        /// </summary>
        /// <param name="vector3">A Vector3.</param>
        ...
        /// <summary>
        /// Converts a vector3 in a point3, without needing casting.
        /// </summary>
        /// <param name="vector3">A Vector3.</param>
        /// <returns>The resulting Point3.</returns>
        public static implicit operator Point3(Vector3 vector3)
        {
        ...
        /// <summary>
        /// Determines whether the specified System.Object is a Vector3 and has the same values as the present vector.
        /// </summary>
        /// <param name="obj">The specified object.</param>
        /// <returns>true if obj is a Vector3 and has the same coordinates as this; otherwise false.</returns>
        ...
        int IComparable.CompareTo(object obj)
        {
            ...
            throw new ArgumentException("Input must be of type Vector3", "obj");
        }
        ...
        ///</summary>
        ///<returns>Returns a reversed vector on success or Vector3.Unset if the vector is invalid.</returns>
