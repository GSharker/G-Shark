...
namespace GShark.Geometry
{
    ...
    public class Plane : IEquatable<Plane>, ITransformable<Plane>
    {
        ...
        /// <returns>The rotated plane (in radiance) with XAxis align to the guide vector.</returns>
        ...
        /// </summary>
        /// <param name="radianceAngle">Angle to rotate the plane, expressed in radians.</param>
        /// <returns>The plan rotated.</returns>
        public Plane Rotate(double radianceAngle)
        {
            Vector3 xRotate = XAxis.Rotate(ZAxis, radianceAngle);
