            ...
            while (j >= 0)
            {
                ...
                for (int i = 1; i <= degree; i++)
                {
                    ...
                    else
                    {
                        ...
                        controlPoints_post[ind - 1] = (Point)Constants.Addition(Constants.Multiplication(controlPoints_post[ind - 1], alfa), Constants.Multiplication(controlPoints_post[ind], 1.0 - alfa));
                    }
                }
