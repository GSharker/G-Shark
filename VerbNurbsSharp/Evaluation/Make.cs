...
namespace VerbNurbsSharp.Evaluation
{
    public class Make
    {
        ...
        /// <returns></returns>
        public static NurbsSurfaceData RationalTranslationalSurface(NurbsCurveData profile, NurbsCurveData rail)
        {
        ...
        public static List<NurbsCurveData> SurfaceBoundaryCurves(NurbsSurfaceData surface)
        {
            throw new NotImplementedException();
        }

        public static NurbsCurveData SurfaceIsocurve(NurbsSurfaceData surface, double u, bool useV = false)
        {
            throw new NotImplementedException();
        }

        public static NurbsSurfaceData LoftedSurface(List<NurbsCurveData> curves, int degreeV = 0)
        {
            throw new NotImplementedException();
        }
        ...
        /// <returns>NurbsSurfaceData object</returns>
        ...
        /// <returns></returns>
        public static NurbsSurfaceData FourPointSurface(Point p1, Point p2, Point p3, Point p4, int degree = 3)
        {
            throw new NotImplementedException();
        }
        ...
        public static NurbsCurveData EllipseArc(Point center, Vector xaxis, Point yaxis, double startAngle, double endAngle)
        {
            throw new NotImplementedException();
        }
        ...
        /// <param name="endAngle">end angle of the arc, between 0 and 2pi, greater than the start angle</param>
        /// <returns>a NurbsCurveData object representing a NURBS curve</returns>
        public static NurbsCurveData Arc(Point center, Vector xaxis, Vector yaxis, double radius, double startAngle, double endAngle)
        {
            throw new NotImplementedException();
        }
        ...
        public static NurbsSurfaceData ExtrudedSurface(Vector axis, double length, NurbsCurveData profile)
        {
            throw new NotImplementedException();
        }
        ...
        public static NurbsSurfaceData CylindricalSurface(Vector axis, Vector xaxis, Point basePt, double height, double radius)
        {
            throw new NotImplementedException();
        }
        ...
        /// <returns></returns>
        public static NurbsSurfaceData RevolvedSurface(NurbsCurveData profile, Point center, Vector axis, double theta)
        {
            throw new NotImplementedException();
        }
        ...
        /// <returns>an object with the following properties: controlPoints, weights, knotsU, knotsV, degreeU, degreeV</returns>
        public static NurbsSurfaceData SphericalSurface(Point center, Vector axis, Vector xaxis, double radius)
        {
            throw new NotImplementedException();
        }
        ...
        /// <returns></returns>
        public static NurbsSurfaceData ConicalSurface(Vector axis, Vector xaxis, Point basePt, double height, double radius)
        {
            throw new NotImplementedException();
        }

        public static NurbsCurveData RationalInterpCurve(List<List<double>> points, int degree, bool homogeneousPoints = false, Point start_tangent = null, Point end_tangent = null)
        {
            throw new NotImplementedException();
        }
    }
